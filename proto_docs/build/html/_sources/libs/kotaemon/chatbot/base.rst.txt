...
The `kotaemon.chatbot.base` module provides foundational classes and functions for defining and managing chatbots.
...
BaseChatBot
~~~~~~~~~~~
.. autoclass:: kotaemon.chatbot.base.BaseChatBot
   :members:
   :undoc-members:
   :show-inheritance:

   **Overview**:
   - `BaseChatBot` serves as the abstract base class for chatbots.
   - Subclasses must implement the `run` method to process messages and produce responses.

---

ChatConversation
~~~~~~~~~~~~~~~~~
.. autoclass:: kotaemon.chatbot.base.ChatConversation
   :members:
   :undoc-members:
   :show-inheritance:

   **Overview**:
   - Manages the state of a chatbot conversation.
   - Handles:
     - History of messages.
     - Starting and ending sessions.
     - Terminal interaction with a chatbot.

Functions
---------

session_chat_storage
~~~~~~~~~~~~~~~~~~~~
.. autofunction:: kotaemon.chatbot.base.session_chat_storage

   **Purpose**:
   - Customizes storage location for chatbot results.


Source Code
------------

The following is the source code for the `base.py` module:
